...
@Component({
  selector: 'app-volailles',
  templateUrl: './volailles.component.html',
  styleUrls: ['./volailles.component.css']
})
export class VolaillesComponent implements OnInit {
  pdfObj = null;
  ...
  getProduit() {
    this.dataService.getVolaille().subscribe((res) => {
      this.data = res;
